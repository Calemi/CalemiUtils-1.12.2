...
public class CUReference {
    ...
    public static final String MOD_VERSION = "1.12.2-1.0.4";
    public static final String MC_VERSION = "[1.12.2]";

    public static final String CLIENT_PROXY_CLASS = "calemiutils.proxy.ClientProxy";
    public static final String SERVER_PROXY_CLASS = "calemiutils.proxy.ServerProxy";
