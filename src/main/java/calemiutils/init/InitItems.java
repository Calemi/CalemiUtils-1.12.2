...
public class InitItems {
    ...
    public static final Item RARITANIUM = new ItemBase("raritanium");
    ...
    public static final Item GOLD_CHIP = new ItemBase("gold_chip");
    public static final Item MOTOR = new ItemBase("motor");
